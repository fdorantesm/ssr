...
/* harmony import */ var _reducers_reducer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../reducers/reducer */ "./reducers/reducer.ts");
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! nanoid */ "nanoid");
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(nanoid__WEBPACK_IMPORTED_MODULE_10__);
...
const App = () => {
  const [state, dispatch] = react__WEBPACK_IMPORTED_MODULE_8___default.a.useReducer(_reducers_reducer__WEBPACK_IMPORTED_MODULE_9__["default"], {
    currentTodo: '',
    todos: []
  });
    ...
    if (state.currentTodo) {
      dispatch({
        ...
        payload: {
          ...
          completed: false,
          createdAt: `${_babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_7___default()()}`
        }
      });
      dispatch({
        type: 'set-current',
...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    default:
      {
        throw new Error(`Unsupported action ${_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_6___default()(action)}`);
      }
  }
};
...
module.exports = __webpack_require__(/*! /Users/sangermes/Desktop/BlockBit/Projects/todo-list/pages/index.tsx */"./pages/index.tsx");
